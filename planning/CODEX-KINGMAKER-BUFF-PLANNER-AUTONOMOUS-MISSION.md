...
is `2628738dbae09051ebce467fd35c2da6dd27f58d`; `main`, `origin/main`, and
annotated tag `v0.0.16` resolve there. Public release:
`https://github.com/howardreith/KingmakerBuffPlanner/releases/tag/v0.0.16`.

The publisher repeated source 39/39, protocol/domain 127/127, runtime
filesystem 8/8, package 4/4, deployment WhatIf 5/5, aggregate 1/1,
deterministic builds 2/2, and release builder 3/3. Published ZIP/DLL/MVID are
...
`49488746-8fa8-46b0-827e-7a73cc00f1af`; independent download agrees. Guarded
install `published-0.0.16-final-install-20260831` is Installed with settings
preserved and other mods verified unchanged.

The only remaining boundary is live in-game evidence: `baseline=0; working=0`.
Do not substitute an ordinary save. No further release-engineering action
remains.
