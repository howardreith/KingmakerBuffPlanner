...
3. Start Kingmaker through Steam in the normal way and confirm Unity Mod Manager lists `KingmakerBuffPlanner` version 0.0.11 once. Version 0.0.12 remains an unpublished local candidate until separately authorized.
